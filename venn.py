...
#--------------------------------------------------------------------
def venn(data, names=None, fill="number",title_name = "lncRNA", show_names=True, show_plot=True, **kwds):
    """
    data: a list
    ...
    if len(data) == 2:
        venn2(data, names, fill, title_name,show_names, show_plot, **kwds)
    elif len(data) == 3:
        venn3(data, names, fill, title_name,show_names, show_plot, **kwds)
    elif len(data) == 4:
        venn4(data, names, fill, title_name, show_names, show_plot, **kwds)
    else:
...
#--------------------------------------------------------------------
def venn4(data=None, names=None, fill="number", title_name = 'lncRNA', show_names=True, show_plot=True, **kwds):
    ...
    if show_plot:
        #pylab.title(title_name, fontsize=16)
        pylab.show()
